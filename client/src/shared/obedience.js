export const OBEDIENCE = [
  {
    ...
    equipment:
      "Buckle collar, 6 foot leather leash, soft training treats and treat bag.",
    register: "/register",
    url: "beginners",
  },
  {
    ...
    age: "5 months or older.",
    equipment:
      "6 ft leash, 3 ft leash, soft treats and training collar of choice.",
    register: "/register",
    url: "basic",
  },
  {
    ...
    prerequisite:
      "Basic voice control and the ability to concentrate on handler in a busy environment.",
  ...
  },
  {
    ...
    prerequisite:
      "Understanding of sit, down, and recall, completion of a novice level class, or instructor approval.",
    age: "Over 6 months. A sit and down with walking on leash helpful.",
    equipment:
      "Flat collar, 6 ft leash, training treats. Other equipment needed for advanced skills will be requested by instructor as the class progresses.",
    register: "/register",
    url: "competition",
  },
];
